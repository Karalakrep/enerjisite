...
<body>
    <div class="d-flex flex-column p-3 bg-dark align-bottom"  style="height:20px">          
        </div>
        ...
        <div class="wrapper d-flex align-items-stretch">
			<nav id="sidebar">
	  		...
	  		<h1><a href="index.html" class="logo">Halk - Yatırım</a></h1>
      ...
      <div id="content" class="p-4 p-md-5 pt-5">
          <iframe name="alan" class=" h-100 w-100" src="slide.aspx">
